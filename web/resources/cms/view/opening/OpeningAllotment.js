Ext.define('Cms.view.opening.OpeningAllotment', {
    ...
    initComponent: function() {
        ...
        var openingStore = Ext.create('Cms.data.store.OpeningByTeamStore',{
        });
        
        
        var memberTree = Ext.create('Cms.view.team.EmployeeAndOpening',{
            title: 'Members & Openings',
            id: 'memberTree',
            collapsible: true,
            animCollapse: true,
            collapsed: true,
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                selectionchange: function(model, records){
                                    ...
                                    memberTree.setOpeningId(openingId);
                                }
                            },
                            dockedItems: [
                                    {
